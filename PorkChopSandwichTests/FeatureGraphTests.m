...
- (void)testAddingNodes
{
    ...
    FeatureGraphNode *aNode = [FeatureGraphNode nodeWithIdentifier:@"A"];
    FeatureGraphNode *bNode = [FeatureGraphNode nodeWithIdentifier:@"B"];
    FeatureGraphNode *cNode = [FeatureGraphNode nodeWithIdentifier:@"C"];
    FeatureGraphNode *dNode = [FeatureGraphNode nodeWithIdentifier:@"D"];

    [graph addEdge:[FeatureGraphEdge edgeWithName:@"A-B"] fromNode:aNode toNode:bNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"B-D"] fromNode:bNode toNode:dNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"C-D"] fromNode:cNode toNode:dNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"A-C"] fromNode:aNode toNode:cNode];
...
- (void)testBiDirectionalEdges
{
    ...
    FeatureGraphNode *cNode = [FeatureGraphNode nodeWithIdentifier:@"C"];
    FeatureGraphNode *dNode = [FeatureGraphNode nodeWithIdentifier:@"D"];
    FeatureGraphNode *fNode = [FeatureGraphNode nodeWithIdentifier:@"F"];
    
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A-C" andWeight:[NSNumber numberWithInt:4]] fromNode:aNode toNode:bNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A-B" andWeight:[NSNumber numberWithInt:3]] fromNode:aNode toNode:cNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C-D" andWeight:[NSNumber numberWithInt:2]] fromNode:cNode toNode:dNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B-D" andWeight:[NSNumber numberWithInt:6]] fromNode:bNode toNode:dNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"D-F" andWeight:[NSNumber numberWithInt:1]] fromNode:dNode toNode:fNode];
...
- (void)testUniDirectionalEdges
{
    ...
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"A -> B" andWeight:[NSNumber numberWithInt:4]] fromNode:aNode toNode:bNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"B -> C" andWeight:[NSNumber numberWithInt:2]] fromNode:bNode toNode:cNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C <-> D" andWeight:[NSNumber numberWithInt:3]] fromNode:cNode toNode:dNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"D -> A" andWeight:[NSNumber numberWithInt:10]] fromNode:dNode toNode:aNode];
...
- (void)testShortestPath
{
    ...
    FeatureGraphNode *cNode = [FeatureGraphNode nodeWithIdentifier:@"C"];
    FeatureGraphNode *dNode = [FeatureGraphNode nodeWithIdentifier:@"D"];
    FeatureGraphNode *eNode = [FeatureGraphNode nodeWithIdentifier:@"E"];
    FeatureGraphNode *fNode = [FeatureGraphNode nodeWithIdentifier:@"F"];
    
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> B" andWeight:[NSNumber numberWithInt:7]] fromNode:aNode toNode:bNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> C" andWeight:[NSNumber numberWithInt:9]] fromNode:aNode toNode:cNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> F" andWeight:[NSNumber numberWithInt:14]] fromNode:aNode toNode:fNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B <-> C" andWeight:[NSNumber numberWithInt:10]] fromNode:bNode toNode:cNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B <-> D" andWeight:[NSNumber numberWithInt:15]] fromNode:bNode toNode:dNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C <-> F" andWeight:[NSNumber numberWithInt:2]] fromNode:cNode toNode:fNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C <-> D" andWeight:[NSNumber numberWithInt:11]] fromNode:cNode toNode:dNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"D <-> E" andWeight:[NSNumber numberWithInt:6]] fromNode:dNode toNode:eNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"E <-> F" andWeight:[NSNumber numberWithInt:9]] fromNode:eNode toNode:fNode];

    FeatureGraphRoute *route = [graph shortestRouteFromNode:aNode toNode:eNode];
...
- (void)testShortestPathSecond
{
    ...
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> B" andWeight:[NSNumber numberWithInt:1]] fromNode:aNode toNode:bNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> C" andWeight:[NSNumber numberWithInt:5]] fromNode:aNode toNode:cNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B <-> D" andWeight:[NSNumber numberWithInt:2]] fromNode:bNode toNode:dNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B <-> E" andWeight:[NSNumber numberWithInt:4]] fromNode:bNode toNode:eNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C <-> D" andWeight:[NSNumber numberWithInt:2]] fromNode:cNode toNode:dNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C <-> E" andWeight:[NSNumber numberWithInt:3]] fromNode:cNode toNode:eNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"D <-> E" andWeight:[NSNumber numberWithInt:1]] fromNode:dNode toNode:eNode];
...
- (void)testShortestPathThird
{
    ...
    FeatureGraphNode *oNode = [FeatureGraphNode nodeWithIdentifier:@"O"];
    FeatureGraphNode *aNode = [FeatureGraphNode nodeWithIdentifier:@"A"];
    FeatureGraphNode *bNode = [FeatureGraphNode nodeWithIdentifier:@"B"];
    FeatureGraphNode *cNode = [FeatureGraphNode nodeWithIdentifier:@"C"];
    FeatureGraphNode *dNode = [FeatureGraphNode nodeWithIdentifier:@"D"];
    FeatureGraphNode *eNode = [FeatureGraphNode nodeWithIdentifier:@"E"];
    FeatureGraphNode *fNode = [FeatureGraphNode nodeWithIdentifier:@"F"];
    FeatureGraphNode *gNode = [FeatureGraphNode nodeWithIdentifier:@"G"];
    FeatureGraphNode *hNode = [FeatureGraphNode nodeWithIdentifier:@"H"];
    FeatureGraphNode *iNode = [FeatureGraphNode nodeWithIdentifier:@"I"];
    FeatureGraphNode *tNode = [FeatureGraphNode nodeWithIdentifier:@"T"];
    
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"O <-> A" andWeight:[NSNumber numberWithInt:1]] fromNode:oNode toNode:aNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"O <-> D" andWeight:[NSNumber numberWithInt:1]] fromNode:oNode toNode:dNode];    
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> B" andWeight:[NSNumber numberWithInt:2]] fromNode:aNode toNode:bNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"A <-> T" andWeight:[NSNumber numberWithInt:9]] fromNode:aNode toNode:tNode];    
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B <-> C" andWeight:[NSNumber numberWithInt:2]] fromNode:bNode toNode:cNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"B <-> F" andWeight:[NSNumber numberWithInt:2]] fromNode:bNode toNode:fNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"C <-> E" andWeight:[NSNumber numberWithInt:1]] fromNode:cNode toNode:eNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"D <-> G" andWeight:[NSNumber numberWithInt:1]] fromNode:dNode toNode:gNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"E <-> F" andWeight:[NSNumber numberWithInt:2]] fromNode:eNode toNode:fNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"E <-> I" andWeight:[NSNumber numberWithInt:2]] fromNode:eNode toNode:iNode];    
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"F <-> H" andWeight:[NSNumber numberWithInt:1]] fromNode:fNode toNode:hNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"G <-> H" andWeight:[NSNumber numberWithInt:1]] fromNode:gNode toNode:hNode];
    [graph addBiDirectionalEdge:[FeatureGraphEdge edgeWithName:@"I <-> T" andWeight:[NSNumber numberWithInt:1]] fromNode:iNode toNode:tNode];

    FeatureGraphRoute *route = [graph shortestRouteFromNode:oNode toNode:tNode];
...
- (void)testRemoveEdgeFromNode
{
    ...
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"A -> B"] fromNode:aNode toNode:bNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"B -> D"] fromNode:bNode toNode:dNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"B -> A"] fromNode:bNode toNode:aNode];    
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"C -> D"] fromNode:cNode toNode:dNode];
    [graph addEdge:[FeatureGraphEdge edgeWithName:@"A -> C"] fromNode:aNode toNode:cNode];
