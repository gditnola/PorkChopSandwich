...
@class FeatureGraphEdge, FeatureGraphNode, FeatureGraphRoute;
 ...
 */
@interface FeatureGraph : NSObject {
    
    /**
    	A collection of FeatureGraphNodes managed by the graph.  Keys will be identifiers for
        ...
        with those coresponding values being FeatureGraphEdge objects
     */
...
/**
	...
	@returns either a FeatureGraphRoute object or nil, if no route is possible
 */
