...
/**
    ...
    FeatureGraphRoute object
 */
@interface FeatureGraphRouteStep : NSObject {
...
@property (nonatomic, retain, readonly) FeatureGraphNode *node;
@property (nonatomic, retain, readonly) FeatureGraphEdge *edge;
